...
VERSION=MPI-OMP
WITH_ACO=-DFT_ACO
#HANDLER = -DFT_ERRORS_ARE_FATAL
HANDLER = -DFT_ERRORS_RETURN
#HANDLER = -DFT_ABORT_ON_FAILURE
#HANDLER = -DFT_IGNORE_ON_FAILURE
#HANDLER = -DFT_RESPAWN_ON_FAILURE
#HANDLER = -DFT_ELASTIC_RESPAWN_ON_FAILURE
KILL_POLICY = -DKILL_AT_50
#KILL_POLICY = -DKILL_AT_25_AND_50
#KILL_POLICY = -DKILL_ALL_BUT_ONE
OPTIM_FLAGS=-O
...
CFLAGS=-fuse-ld=gold $(WARN_FLAGS) $(OPTIM_FLAGS) -I ~/mpi402/include/ $(WITH_ACO) $(HANDLER) $(KILL_POLICY)
